  ...
  <section class="admin-page">
    <div class="ap-header">
      ...
      <div class="ap-header__actions">
        ...
        <button class="btn btn-primary" @click="openAdd"><UIcon name="i-lucide-plus" />Add Project</button>
      </div>
    </div>
    ...
    <AdminTable :columns="columns" :rows="data || []" :loading="pending" empty-title="No projects">
